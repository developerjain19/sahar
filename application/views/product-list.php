                                ...
                                ?>
                                        ...
                                        <li><span><img src="<?= base_url() ?>uploads/product/<?= $row['product_image'] ?>" class="product-img"></span>
                                            ...
                                            <div class="buttons-to-right">
                                                <a href="<?= base_url('update-product/' . encryptId($row['product_id'])) ?>" class="button btn-primary" onclick="return confirm('Are You Sure?')"><i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('product-list') ?>?BdID=<?= $row['product_id'] ?>" class="button btn-danger" onclick="return confirm('Are You Sure?')"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </li>
