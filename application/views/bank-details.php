                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded" placeholder="Ex:75523100058" name="acc_no" value="<?= (($bank != '') ? $bank['0']['acc_no'] : '') ?>" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="mb-1">IFSC</label>
                                                    <input type="text" class="form-control rounded" placeholder="IFSC" name="ifsc" value="<?= (($bank != '') ? $bank['0']['ifsc'] : '') ?>" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
