                                    ...
                                    <form method="post" class="row" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <input class="form-control rounded" type="text" name="qr_name" value="<?= (($tag == 'Edit') ? $payment_details_list['0']['qr_name'] : '') ?>" required>

                                            </div>
                                            <div class="col-lg-4 col-md-4">
                                                <label class="mb-1">QR Number</label>
                                                <input class="form-control rounded" type="text" name="qr_no" value="<?= (($tag == 'Edit') ? $payment_details_list['0']['qr_no'] : '') ?>" required>
