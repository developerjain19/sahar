					...
					<div class="signup-screen-wrap">
						<div class="signup-screen-single">
							<div class="text-center mb-4">
								<h4 class="m-0 ft-medium">Please enter your Phone number to get your password</h4>
							</div>
							 <p><?php
							...
							<form class="submit-form" action="" method="POST">
								<div class="form-group">
									<label class="mb-1">Enter your Phone No.</label>
									<input type="text" class="form-control" name="mobile" placeholder="Your Registered Phone Number" required>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-md full-width theme-bg text-light rounded ft-medium" value="Get Password" />
								</div>
