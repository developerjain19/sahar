                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control rounded" name="mobile" maxlength="10" id="company_contact" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
											<div class="d-flex align-items-center justify-content-between">
												<div class="" style="width: 100%">
													<input id="dd" class="checkbox-custom" name="policy" type="checkbox" value="1" required>
													<label for="dd" class="checkbox-custom-label">By clicking Sign Up, you agree to our <a href="<?= base_url('term-condition') ?>" style="color: #f41b3b; text-decoration: underline;">Terms & Condition</a> and <a href="<?= base_url('privacy-policy') ?>" style="color: #f41b3b; text-decoration: underline;">Privac Policy.</a> You may receive SMS notifications from us.</label>
												</div>
											</div>
										</div>
