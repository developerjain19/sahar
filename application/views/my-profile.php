										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-6">
												<div class="form-group">
													...
													if ($datacomrow != '') {
													?>
														<input type="file" class="form-control rounded" name="company_logo_temp" accept="image/x-png,image/jpg,image/jpeg"/>
													...
													?>
														<input class="form-control rounded" type="file" name="company_logo" accept="image/x-png,image/jpg,image/jpeg">
													<?php }
													?>
