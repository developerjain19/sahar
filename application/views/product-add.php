                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-4 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input list="product_subcate" name="product_subcate" id="browser" class="form-control" placeholder="Select Sub Category" value="<?= (($tag == 'Edit') ? $product_list['0']['product_subcate'] : '') ?>">
                                        <datalist id="product_subcate" requierd>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <br>
                                    <div class="form-group">
                                        <button type="submit" class="btn theme-bg text-light rounded"><?= (($tag == 'Edit') ? 'Save Changes' : 'Add Product') ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
