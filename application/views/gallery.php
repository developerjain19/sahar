                                    ...
                                    <form method="post" class="row" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <label class="mb-1">Gallery image (Only: JPG PNG and JPEG)</label>
                                                <input class="form-control rounded" type="file" name="image" accept=".png,.jpg,.jpeg" required>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <th scope="row"><?= $i ?></th>
                                                            <td><?= $row['title'] ?></td>
                                                            <td><img src="<?= base_url() ?>uploads/gallery/<?= $row['image'] ?>" height="130px"></td>

                                                            <td> <a href="<?= base_url('gallery') ?>?BdID=<?= $row['gallery_id'] ?>" onclick="return confirm('Are You Sure?')" class="button action_btn"><i class="fa fa-trash text-danger"></i></a></td>
                                                        </tr>
