                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded"  placeholder="Ex: yourcompany-name" name="company_web_title" id="web_company_name" value="<?= (($getcard != '') ? $getcard['0']['company_web_title'] : '') ?>" <?= (($getcard['0']['company_web_title'] != '') ? 'readonly' : '') ?>  />

                                                    <!--<?= (($getcard['0']['company_web_title'] != '') ? '<p class=""> If you want to change your Vcard Url Please Chat with us on Whatsapp</p>' : '') ?>-->
