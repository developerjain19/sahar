...
while ($select_banner_row = $select_banner->fetch_assoc()) {
    ...
    $output .= '     <tr>
                                <td> ' . $sno . ' </td>
                                <td><img src="../img/banner/' . $select_banner_row["banner_logo"] . '" width="100" height="70" alt="banner Logo" id="banner_logo' . $select_banner_row['banner_id'] . '" onerror="defult_image(id);" /></td>
