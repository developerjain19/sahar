...
if (isset($_POST['cate_submit'])) {
    ...
    if (in_array($banner_logo_imageFileType, $extensions_arr)) {
        ...
        $banner_logo_target_location = '../img/banner/' . $banner_logo_newfilename;
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-6">
                                                        <div class="form-line">
                                                            <label>Link :</label>
                                                            <input type="url" maxlength="255" class="form-control" placeholder="banner link" id="banner_name" name="banner_name" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <div class="form-line">
